...
Det är vanligt att använda grekiska bokstäver för parametrar, såsom 
$\mu$, $\sigma$ och $\alpha$. 
...
### Skapa ett uttryck med en summa eller produkt {.unnumbered}
...
Du kan också hitta dem här [länk till sida i canvas]( https://canvas.education.lu.se/courses/28233/pages/lab-1-uttryck)
