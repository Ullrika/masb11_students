...
:::{.callout-note icon=false}
### Uppgift 1.5
**I mån av tid:** Pröva vad som händer då du summerar exponentialfördelade slumvariabler med väntevärde 1 (`rexp(1000,1)`).  Hur många variabler behövs summeras innan summan kan approximeras med en normalfördelning?
:::
...
:::{.callout-note icon=false}
### Uppgift 2.2
Det kan vara intressant att jämföra grupperna genom att bilda differensen mellan de två gruppmedelvärdena. Använd dig av centrala gränsvärdessatsen för att säga någon om vilken fördelning differensen i medelvärden har. Skatta parametrarna (väntevärde och varians) i denna fördelning. 
:::
...
:::{.callout-note icon=false}
### Uppgift 2.3
Är det ett stort problem att variabeln inte är normalfördelad i de båda grupperna från början? Kan man åtgärda detta på något sätt?
:::
...
> Kör (Render) denna fil till en PDF och ladda upp det som en laborationsrapport på Canvas. Forsätt sedan med Miniprojekt I under laboration 2!
